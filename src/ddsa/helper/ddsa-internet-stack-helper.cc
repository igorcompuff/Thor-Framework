...
void
DdsaInternetStackHelper::Initialize ()
{
...
DdsaInternetStackHelper::DdsaInternetStackHelper (const DdsaInternetStackHelper &o)
{
...
void
DdsaInternetStackHelper::Reset (void)
{
  delete m_routing;
  m_routing = 0;
  delete m_routingv6;
...
void 
DdsaInternetStackHelper::SetRoutingHelper(const Ipv4RoutingHelper &routing)
{
  delete m_routing;
...
void
DdsaInternetStackHelper::SetRoutingHelper (const Ipv6RoutingHelper &routing)
{
  delete m_routingv6;
...
void
DdsaInternetStackHelper::SetIpv4StackInstall (bool enable)
{
  m_ipv4Enabled = enable;
}

void DdsaInternetStackHelper::SetIpv6StackInstall (bool enable)
{
  m_ipv6Enabled = enable;
}

void DdsaInternetStackHelper::SetIpv4ArpJitter (bool enable)
{
  m_ipv4ArpJitterEnabled = enable;
}

void DdsaInternetStackHelper::SetIpv6NsRsJitter (bool enable)
{
  m_ipv6NsRsJitterEnabled = enable;
}

int64_t
DdsaInternetStackHelper::AssignStreams (NodeContainer c, int64_t stream)
{
...
void
DdsaInternetStackHelper::SetTcp (const std::string tid)
{
  m_tcpFactory.SetTypeId (tid);
}

void 
DdsaInternetStackHelper::SetTcp (std::string tid, std::string n0, const AttributeValue &v0)
{
  m_tcpFactory.SetTypeId (tid);
...
void 
DdsaInternetStackHelper::Install (NodeContainer c) const
{
  for (NodeContainer::Iterator i = c.Begin (); i != c.End (); ++i)
    {
      Install (*i);
...
void 
DdsaInternetStackHelper::InstallAll (void) const
{
...
void
DdsaInternetStackHelper::Install (Ptr<Node> node) const
{
  if (m_ipv4Enabled)
    {
      if (node->GetObject<Ipv4> () != 0)
        {
          NS_FATAL_ERROR ("DdsaInternetStackHelper::Install (): Aggregating "
...
void
DdsaInternetStackHelper::Install (std::string nodeName) const
{
...
bool
DdsaInternetStackHelper::PcapHooked (Ptr<Ipv4> ipv4)
{
...
void 
DdsaInternetStackHelper::EnablePcapIpv4Internal (std::string prefix, Ptr<Ipv4> ipv4, uint32_t interface, bool explicitFilename)
{
  ...
  if (!PcapHooked (ipv4))
    {
      ...
      NS_ASSERT_MSG (ipv4L3Protocol, "DdsaInternetStackHelper::EnablePcapIpv4Internal(): "
      ...
      NS_ASSERT_MSG (result == true, "DdsaInternetStackHelper::EnablePcapIpv4Internal():  "
...
bool
DdsaInternetStackHelper::PcapHooked (Ptr<Ipv6> ipv6)
{
...
void 
DdsaInternetStackHelper::EnablePcapIpv6Internal (std::string prefix, Ptr<Ipv6> ipv6, uint32_t interface, bool explicitFilename)
{
  ...
  if (!PcapHooked (ipv6))
    {
      ...
      NS_ASSERT_MSG (ipv6L3Protocol, "DdsaInternetStackHelper::EnablePcapIpv6Internal(): "
      ...
      NS_ASSERT_MSG (result == true, "DdsaInternetStackHelper::EnablePcapIpv6Internal():  "
...
bool
DdsaInternetStackHelper::AsciiHooked (Ptr<Ipv4> ipv4)
{
...
void 
DdsaInternetStackHelper::EnableAsciiIpv4Internal (
  Ptr<OutputStreamWrapper> stream, 
  std::string prefix, 
  Ptr<Ipv4> ipv4, 
  uint32_t interface,
      ...
      if (!AsciiHooked (ipv4))
        {
          ...
          NS_ASSERT_MSG (result == true, "DdsaInternetStackHelper::EnableAsciiIpv4Internal():  "
...
bool
DdsaInternetStackHelper::AsciiHooked (Ptr<Ipv6> ipv6)
{
...
void 
DdsaInternetStackHelper::EnableAsciiIpv6Internal (
  Ptr<OutputStreamWrapper> stream, 
  std::string prefix, 
  Ptr<Ipv6> ipv6, 
  uint32_t interface,
      ...
      if (!AsciiHooked (ipv6))
        {
          ...
          NS_ASSERT_MSG (result == true, "DdsaInternetStackHelper::EnableAsciiIpv6Internal():  "
