 ...
 *  - ns3::ArpL3Protocol
 *  - ns3::ddsa::Ipv4L3ProtocolDdsaAdapter
 ...
 */
class DdsaInternetStackHelper : public PcapHelperForIpv4, public PcapHelperForIpv6,
                            public AsciiTraceHelperForIpv4, public AsciiTraceHelperForIpv6
{
public:
  /**
   * Create a new DdsaInternetStackHelper which uses a mix of static routing
  ...
  /**
   * Destroy the DdsaInternetStackHelper
   */
