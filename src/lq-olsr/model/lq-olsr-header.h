...
#ifndef LQ_OLSR_HEADER_H
#define LQ_OLSR_HEADER_H
...
namespace lqolsr {
  ...
  public:
    ...
    LqHello& GetLqHello ()
    {
      if (m_messageType == 0)
	{
	  m_messageType = LQ_HELLO_MESSAGE;
	}
      else
	{
    ...
    /**
     * Set the message type to LQ_TC and return the message content.
     * \returns The LQ_TC message.
     */
    LqTc& GetLqTc ()
    {
      if (m_messageType == 0)
	{
	  m_messageType = LQ_TC_MESSAGE;
	}
      else
	{
	  NS_ASSERT (m_messageType == LQ_TC_MESSAGE);
	}
      return m_message.lqTc;
    }
     ...
     * \returns The LQ_HELLO message.
     */
    const LqHello& GetLqHello () const
    {
      NS_ASSERT (m_messageType == LQ_HELLO_MESSAGE);
      return m_message.lqHello;
    }
    ...
    /**
     * Get the LQ_TC message.
     * \returns The LQ_TC message.
     */
    const LqTc& GetLqTc () const
    {
      NS_ASSERT (m_messageType == LQ_TC_MESSAGE);
      return m_message.lqTc;
    }
